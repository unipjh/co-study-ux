...
const SCENARIOS = ['전체', 'S1', 'S2', 'S3']
const SERVICES = ['전체', '유니브AI', 'Lilys AI', 'NotebookLM', 'ChatGPT', 'Claude', '기타']
...
export default function Home() {
  ...
  return (
    <main style={{ maxWidth: '900px', margin: '0 auto', padding: '32px 16px', fontFamily: 'Noto Sans KR, sans-serif' }}>
      {/* 헤더 영역 */}
      <div style={{ marginBottom: '28px' }}>
        <h1 style={{ fontSize: '22px', fontWeight: 600, color: '#1a1916', margin: '0 0 6px' }}>
          AI 학습 UX 아카이브
        </h1>
